...
?>
	...
	<div id="runSimulationPage" class="page" action="basic_settings_send.php" method="post" style="font-family: 'Lucida Grande'; text-align: center">
        <form class="pure-form " action="basic_settings_send.php" method="post">
...
<br>
        <!-- FORM 1-->
        <div id="batch_1" class="formBox"style="font-family: 'Lucida Grande'">
<!--Section 1.1-->
            <div class="startEndTime stepBox " style="">
                <div class='stepCircle'>1</div>
...
<!--Section 1.5-->
        ...
        <!-- FORM 2-->
        <div id="batch_2" class="formBox " style="display: none">

<!--    Section 2.1        -->
            <div class="startEndTime stepBox" style="margin-left: auto">
                <div class='stepCircle'>1</div>
                <h3 >What Batch Are You Editing <span class="hint--bottom-right hint--rounded hint--large" aria-label= "Enter the time of day that your engineer begins his/her shift."><sup>(?)</sup></span></h3>
...
<!--  Section 2.5-->
 ...
 <!--Section 2.6-->
        ...
        <!--FORM 3-->
        <div id="batch_3" class="pure-form formBox" style="display: none">
         <!-- Section 3.1-->
    ...
    <!-- Section 3.2-->
       ...
       <!-- Section 3.3-->
        ...
        <!-- BOTTOM OF PAGE-->
        <div id="bottomNav" style="text-align: center">

            <ul>
                <div id="taskAdder" style="text-align: center; padding-bottom: 20px;" >
                    <h3 id="addBatchText"style="color: #4CAF50; font-family: 'Lucida Grande'"><button id="addTaskButton" type="button" class="roundButton" style=" box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2); background-color: #4CAF50;" onclick=
                        <?php echo "addBatch()"; ?>
                        ><strong>+</strong></button> Add Batch</h3>
                </div>

                    <div class="dropdown" style="margin-bottom: 160px; margin-left: -90px" >
                        <button  class="pure-button pure-button-success" name="run_sim" style="background-color: #4CAF50; box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);">Run Simulation &#8680<span class="hint--right hint--rounded hint--large" aria-label= "the number of replications, or the number of simulated trips. Note that more trips provide more precise results, but it may also increase the processing time"><sup>(&#x003F;)</sup></span> </button>
