...
<!--                --><?php //echo $_SESSION['parameters']['numBatch'];?>
                ...
                <div class="tab" style=" font-family: 'Lucida Grande'">
...
<!--Dispatcher-->
                <div id="dispatcher" class="tabcontent" >
                        ...
                        <div class="stepBox">
                            ...
                            <h1 style="padding:5px; margin: auto; font-family: 'Lucida Grande'; background-color: #3e67ad; color: white">Dispatcher</h1>
...
<!--Batch 1-->
             <div id="batch_1" class="tabcontent" >
				...
				<form class="pure-form " id="taskParameters" action="adv_settings_send.php" method="post">
                    ...
                    <h1 style="padding:5px; margin: auto; font-family: 'Lucida Grande'; background-color: #7cd0ff; color: white">Batch 1</h1>
					<div class = "pure-table pure-table-bordered"id='taskParameterTable' style="font-family: 'Lucida Grande'">
						<?php
							$index = 0;
							foreach (array_keys($_SESSION['tasks']) as $task) {
...
<!--Batch 2 -->
                <div id="batch_2" class="tabcontent" >
                    ...
                    <form class="pure-form " id="taskParameters" action="adv_settings_send.php" method="post">
                        ...
                        <h1 style="padding:5px; margin: auto; font-family: 'Lucida Grande'; background-color: #639752; color: white">Batch 2</h1>
                        <div class = "pure-table pure-table-bordered"id='taskParameterTable' style="font-family: 'Lucida Grande'">
                            <?php
                            $index = 0;
                            foreach (array_keys($_SESSION['tasks']) as $task) {
...
<!-- Batch 3-->
                <div id="batch_3" class="tabcontent" >
                    ...
                    <form class="pure-form " id="taskParameters" action="adv_settings_send.php" method="post">
                        ...
                        <h1 style="padding:5px; margin: auto; font-family: 'Lucida Grande'; background-color: #b9594b; color: white">Batch 3</h1>
                        <div class = "pure-table pure-table-bordered"id='taskParameterTable' style="font-family: 'Lucida Grande'">
                            <?php
                            $index = 0;
                            foreach (array_keys($_SESSION['tasks']) as $task) {
